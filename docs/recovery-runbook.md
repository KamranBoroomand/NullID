...
Use this checklist to recover the repo build, release packaging flow, or static-site deployment from a clean machine or after a broken release/deploy. This runbook stays repo-focused; host-specific verification remains in [`docs/deployment-verification-checklist.md`](./deployment-verification-checklist.md).
