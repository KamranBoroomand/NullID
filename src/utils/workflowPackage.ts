...
export type WorkflowPackageSurface = "web" | "cli" | "unknown";
export type WorkflowPackageType = "bundle" | "report";
export type WorkflowPackageTrustIdentity = "not-asserted";
export type WorkflowPackageSignatureMethod = "none";
export type WorkflowPackageEncryptionMethod = "none";
export type WorkflowPackageArtifactKind = "text" | "json" | "binary" | "manifest" | "reference";

export interface WorkflowPackagePreset {
  id: string;
  label: string;
  summary?: string;
}
...
export interface WorkflowPackageReport {
  purpose?: string;
  audience?: string;
...
export interface WorkflowPackageTrust {
...
export type WorkflowPackageVerificationState = "unsigned" | "integrity-checked" | "mismatch" | "invalid";

export interface WorkflowPackageArtifactVerification {
  id: string;
  role: string;
  label: string;
  kind: WorkflowPackageArtifactKind;
...
export function createSanitizeWorkflowPackage(input: CreateSanitizeWorkflowPackageInput): WorkflowPackage {
