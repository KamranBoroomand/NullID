export const guidePhraseTranslations: Record<string, { fa: string; ru: string }> = {
  ...
  "No analytics, no network requests, and no cloud dependency for core tools.": {
    fa: "بدون تحلیل، بدون درخواست شبکه و بدون وابستگی ابری برای ابزارهای اصلی.",
    ru: "Без аналитики, без сетевых запросов и без облачной зависимости для основных инструментов.",
  },
  ...
  "Signed export verification": {
    fa: "اعتبارسنجی خروجی امضاشده",
    ru: "Проверка подписанного экспорта",
  },
  ...
  "NullID operator manual": { fa: "راهنمای اپراتور NullID", ru: "Руководство оператора NullID" },
  ...
  "NullID is an offline-first security workbench for preparing, inspecting, and exporting sensitive material under local operator control.": { fa: "NullID یک میزکار امنیتیِ محلی‌محور برای آماده‌سازی، بررسی و خروجی‌گرفتن از مطالب حساس زیر کنترل اپراتور محلی است.", ru: "NullID — это офлайн-ориентированная рабочая среда безопасности для подготовки, проверки и экспорта чувствительных материалов под локальным контролем оператора." },
