...
import { analyzeMetadataFromBuffer, detectMetadataFormat, sanitizePdfMetadataBuffer, } from "../utils/metadataAdvanced.js";
describe("metadata advanced", () => {
    it("detects OOXML document formats from archive markers", () => {
        const bytes = concatBytes(Uint8Array.from([0x50, 0x4b, 0x03, 0x04]), ascii("[Content_Types].xml docProps/core.xml word/document.xml"));
    ...
    it("detects video metadata hints and suggests external sanitization command", () => {
        const bytes = concatBytes(Uint8Array.from([0x00, 0x00, 0x00, 0x14, 0x66, 0x74, 0x79, 0x70, 0x6d, 0x70, 0x34, 0x32]), ascii("com.apple.quicktime.location.ISO6709"));
