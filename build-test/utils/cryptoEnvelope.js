...
export async function deriveKey(passphrase, salt, iterations = 250_000) {
    ...
    const key = await crypto.subtle.deriveKey({ name: "PBKDF2", salt: saltBytes.buffer, iterations, hash: "SHA-256" }, keyMaterial, { name: "AES-GCM", length: 256 }, false, ["encrypt", "decrypt"]);
