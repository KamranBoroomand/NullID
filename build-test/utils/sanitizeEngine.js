const rules = [
    ...
    },
    {
        ...
        apply: (input) => replaceWithCount(input, /\b(?:ghp_[A-Za-z0-9]{36}|github_pat_[A-Za-z0-9_]{20,})\b/g, "[github-token]"),
    },
    {
        key: "maskSlackToken",
    ...
    },
    {
        ...
        apply: (input) => replaceWithCount(input, /-----BEGIN (?:[A-Z0-9 ]*?)PRIVATE KEY-----[\s\S]*?-----END (?:[A-Z0-9 ]*?)PRIVATE KEY-----/g, "[private-key]"),
    },
    {
        key: "stripCookies",
        label: "Strip cookies",
