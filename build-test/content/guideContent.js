export const guideTools = [
    ...
    },
    {
        ...
        whatItDoes: "Local generator with advanced constraints, large virtual passphrase dictionaries, strength lab auditing, and batch candidate generation.",
    ...
    },
    {
        key: "vault",
        title: "Secure Notes",
        whatItDoes: "IndexedDB-backed vault with AES-GCM per note, activity-based auto-lock countdown, note templates, analytics/report export, tab-hide lock, and panic hotkey (Ctrl+Shift+L).",
