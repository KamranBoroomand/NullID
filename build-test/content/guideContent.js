export const guideTools = [
    ...
    },
    {
        key: "sanitize",
        title: "Log Sanitizer",
        whatItDoes: "Rule-based scrubbing for logs with diff preview, signed local policy packs, batch file sanitization, baseline policy merge, and safe-share bundle export.",
    ...
    },
    {
        ...
        whatItDoes: "Reads local image metadata (JPEG/TIFF EXIF, PNG/WebP/GIF hints), surfaces browser compatibility diagnostics, re-encodes images to strip metadata, and pairs with CLI workflows for PDF/Office metadata cleaning.",
