export const guideTools = [
    {
        key: "hash",
        title: "Hash & Verify",
        whatItDoes: "Compute SHA-256 / SHA-512 / SHA-1 (legacy) for text or files, verify against expected digests, and export integrity manifests/batch hash reports.",
    ...
    },
    {
        ...
        whatItDoes: "NULLID envelope (PBKDF2 + AES-GCM) for sealing text or files; supports profile/custom KDF settings, envelope-header inspection, passphrase strength checks, encrypted download, and decrypt with AAD.",
    ...
    },
    {
        ...
        whatItDoes: "Local password/passphrase generator, strength lab, batch candidate generation, and password storage hashing/verification with Argon2id, PBKDF2-SHA256, and legacy migration options.",
        whatWhen: [
    ...
    },
    {
        key: "vault",
        title: "Secure Notes",
        whatItDoes: "AES-GCM note vault with IndexedDB storage, localStorage fallback in restricted runtimes, activity-based auto-lock countdown, note templates, analytics/report export, tab-hide lock, and panic hotkey (Ctrl+Shift+L).",
    ...
    },
    {
        key: "selftest",
        title: "Self-test",
        whatItDoes: "Runs local runtime checks for crypto, storage, browser capability support, and responsiveness, and can export a diagnostic report.",
        whatWhen: [
...
export const guideExtras = [
    {
        ...
        whatItDoes: "Save or load preferences stored under the nullid:* keys in localStorage, with integrity checks and optional shared-passphrase HMAC metadata.",
    ...
    },
    {
        ...
        whatItDoes: "Choose the right primitive: integrity hashes detect changes, password storage hashes verify a secret without storing it, and encryption keeps data reversible to authorized readers.",
        whatWhen: [
