...
function highlight(text, matches, emptyLabel) {
    if (!matches.length)
        return _jsx("span", { className: "muted", children: emptyLabel });
    const sorted = [...matches].sort((a, b) => a.start - b.start);
    const parts = [];
    let cursor = 0;
